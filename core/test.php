...
// exec($path);
$name = "Monitoring_P"; 
$name = $name."-".date("Y-m-d_H_i");   
$name2 = "Main"; 
$name2 = $name2."-".date("Y-m-d_H_i");
$name3 = "Monitoring_R"; 
$name3 = $name3."-".date("Y-m-d_H_i");

exec('/var/www/html3/plugins/wkhtmltox/bin/wkhtmltoimage http://192.168.62.231:82/main-guest.php /var/www/html3/tableshoots/'.$name2.'.jpg' );
echo "JPG-Main Created Successfully";
exec('/var/www/html3/plugins/wkhtmltox/bin/wkhtmltoimage http://192.168.62.231:82/monitoringP-guest.php /var/www/html3/tableshoots/'.$name.'.jpg' );
echo "JPG-Planyear Created Successfully";
exec('/var/www/html3/plugins/wkhtmltox/bin/wkhtmltoimage http://192.168.62.231:82/monitoringR-guest.php /var/www/html3/tableshoots/'.$name3.'.jpg' );
echo "JPG-PlanPlan Created Successfully";


$mail = new PHPMailer;
$mail->setFrom('info@giprozdraw.ru', 'Gipro-Bot');
$mail->addAddress('it@giprozdraw.ru', ' ');
$mail->addAddress('murashovaei@yandex.ru', ' ');
$mail->addAddress('levin@giprozdraw.ru', ' ');
$mail->addAddress('archiv@giprozdraw.ru', ' ');
$mail->addAddress('ss@giprozdraw.ru', ' ');
$mail->addAddress('mg@giprozdraw.ru', ' ');
$mail->addAddress('bigboss@giprozdraw.ru', ' ');
$mail->addAddress('vasenkov@giprozdraw.ru', ' ');   
$mail->addAddress('semenova-iv@giprozdraw.ru', ' ');
$mail->addAddress('n.polyakov@giprozdraw.ru', ' ');
$mail->addAddress('gavrilin@giprozdraw.ru', ' ');
$mail->addAddress('econom-plan@giprozdraw.ru', ' ');
$mail->addAddress('ppm@giprozdraw.ru', ' ');
$mail->addAddress('oos@giprozdraw.ru', ' ');
$mail->addAddress('odi@giprozdraw.ru', ' ');
$mail->addAddress('kr@giprozdraw.ru', ' ');
$mail->addAddress('kr-glazkov@giprozdraw.ru', ' ');
$mail->addAddress('ar-amelko@giprozdraw.ru', ' ');
$mail->addAddress('ar-verstunina@giprozdraw.ru', ' ');
$mail->addAddress('ar-guryanov@giprozdraw.ru', ' ');
$mail->addAddress('ar-soloviova@giprozdraw.ru', ' ');
$mail->addAddress('genplan@giprozdraw.ru', ' ');
$mail->addAddress('vk@giprozdraw.ru', ' ');
$mail->addAddress('avt@giprozdraw.ru', ' ');
$mail->addAddress('hs@giprozdraw.ru', ' ');
$mail->addAddress('smeta@giprozdraw.ru', ' ');
$mail->addAddress('ov-1@giprozdraw.ru', ' ');
$mail->addAddress('ov-2@giprozdraw.ru', ' ');
$mail->addAddress('ot@giprozdraw.ru', ' ');
$mail->addAddress('th@giprozdraw.ru', ' ');
$mail->addAddress('eo@giprozdraw.ru', ' ');
$mail->addAddress('pos@giprozdraw.ru', ' ');
$mail->addAddress('ts@giprozdraw.ru', ' ');
$mail->addAddress('krukov@giprozdraw.ru', ' ');
$mail->addAddress('lem@giprozdraw.ru', ' ');
$mail->addAddress('mikolishina-l@giprozdraw.ru', ' ');
$mail->addAddress('msn@giprozdraw.ru', ' ');
$mail->addAddress('0085656k@gmail.com', ' ');
$mail->addAddress('antonag@list.ru', ' ');
$mail->addAttachment('/var/www/html3/tableshoots/'.$name2.'.jpg'); 
$mail->addAttachment('/var/www/html3/tableshoots/'.$name.'.jpg');  
$mail->addAttachment('/var/www/html3/tableshoots/'.$name3.'.jpg');  
$mail->Subject = 'TableTask';
